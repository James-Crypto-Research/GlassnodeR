...
get_fees_mean <- function(asset="BTC",since=NULL,until=NULL,
  ...
  x <- do.call(call_glassnode_api, c(
    list(path = glue::glue("v1/metrics/fees/volume_mean")),
    params
  )) |>
    tibble::as_tibble() |>
...
get_fees_median <- function(asset="BTC",since=NULL,until=NULL,
  ...
  params <- do.call(make_params, tmp)
  x <- do.call(call_glassnode_api, c(
    list(path = glue::glue("v1/metrics/fees/volume_median")),
    params
  )) |>
    tibble::as_tibble() |>
...
get_fees_total <- function(asset="BTC",since=NULL,until=NULL,
  ...
  params <- do.call(make_params, tmp)
  x <- do.call(call_glassnode_api, c(
    list(path = glue::glue("v1/metrics/fees/volume_sum")),
    params
  )) |>
    tibble::as_tibble() |>
...
get_exchange_fees <- function(asset="BTC",since=NULL,until=NULL,
  ...
  params <- do.call(make_params, tmp)
  x <- do.call(call_glassnode_api, c(
    list(path = glue::glue("v1/metrics/fees/exchanges_sum")),
    params
  )) |>
    tibble::as_tibble() |>
